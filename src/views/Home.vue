...
export default {
  ...
  data: function () {
    return {
      products: [],
      images: [
        "https://www.mercedeshoffman.com/static/dealer-12887/MYCO_MY22_Dealer_Carousels_GLS_MSRP1400x514.jpg",
        "https://www.mercedeshoffman.com/static/dealer-12887/MYCO_MY22_Dealer_Carousels_GLE_MSRP1400x514__1_.jpg",
        "https://di-uploads-pod2.dealerinspire.com/motorwerksporsche/uploads/2022/03/2021-macan-1800x760.png",
      ],
      nameFilter: "",
    };
  },
  ...
  <div class="home">
    ...
    <section id="features">
      <div class="row">
        <div class="col-lg-4">
          <img
            src="https://www.mercedeshoffman.com/assets/styles/680/images/quicknav-03.jpg"
            width="380"
            height="179"
          />
          <h3 class="todos">Specials</h3>
          <p>Discover Mercedes-Benz latest specials, rebates and incentives.</p>
        </div>
        <div class="col-lg-4">
          <img
            src="https://www.mercedeshoffman.com/assets/styles/680/images/quicknav-04.jpg"
            width="380"
            height="179"
          />
          <h3 class="todos">Test Drive</h3>
          <p>Schedule your appointment now and get behind the wheel.</p>
        </div>
        <div class="col-lg-4">
          <img
            src="https://www.mercedeshoffman.com/assets/styles/680/images/quicknav-01.jpg"
            width="380"
            height="179"
          />
          <h3 class="todos">Service</h3>
          <p>Quick, easy, and convenient. Schedule your appointment.</p>
        </div>
      </div>
    </section>
        ...
        <div id="block4">
          <div class="row text-center-xs">
            <div class="col-sm-4 col-md-3 col-md-offset-2 hidden-xs">
              <div class="margin-bottom-2x visible-xs clearfix"></div>
              <div
                class="img-background img-cover lazy"
                title="Genuine Mercedes-Benz Parts"
                style="
                  background-image: url(https://s3.amazonaws.com/rparts-sites/images/a733fa9b25f33689e2adbe72199f0e62/2afb744a08e580ac3f3dbfd0001a8e07.jpg);
                  padding-top: 90%;
                  width: 20;
                "
              ></div>
            ...
            <div class="col-sm-8 col-md-5 col-xs-12">
              <p class="text-uppercase hidden-xs">Genuine Mercedes-Benz Parts</p>
              <h3 class="h2 margin-top-x">Genuine Mercedes-Benz parts you can trust</h3>
              <p>
                Owning a Mercedes-Benz means never having to settle for anything less than the best. So you can rest
                assured knowing that the quality and craftsmanship we put into making your vehicle is the same as what
                we put into both our new and remanufactured parts.
              </p>
              <a class="btn btn-outline-primary">Order Parts</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="block-text rel zmin">
            ...
            <p>
              Never before has there been a good film portrayal of ancient Greece's favourite myth. So why would
              Hollywood start now? This latest attempt at bringing the son of Zeus to the big screen is brought to us by
              X-Men: The last Stand director Brett Ratner. If the name of the director wasn't enough to dissuade ...
            </p>
